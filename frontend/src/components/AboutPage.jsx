    ...
    return (
        <AboutDiv id='about' >
            ...
            <p>
                ...
                It only takes into account races that took place on {racetime} in the 'Bingo' category and that used a normal {bingoCard}.
                ...
                A player that does not have any finished Bingo time will not appear on the board yet.
                The leaderboard retrieves the latest data from Racetime once a day at <span>9am UTC</span>.
            </p>
            <h2>
                Features
            </h2>
            ...
            <p>
                For each Bingo result, the <span>'aged' time</span> is calculated.
            ...
            <p>
                Your <span>leaderboard score</span> is directly tied to your leaderboard time.
                To calculate it, the leaderboard time is converted to seconds and linearly scaled to a number that's generally between 0 and 1.
                A 1:05 leaderboard time maps to 0, and a 3:00 to 1.
                Then a sigmoid function (<span>2 / (1 + e^(4*x))</span>) is applied to this number, in order to make differences in points less steep for higher leaderboard times.
                Finally, the number is multiplied by 1000 to result in the score.
                For example, a 1:05 leaderboard time would correspond to a score of 1000 points, a 1:20 to 745 points, and a 2:00 to 275 points.
            </p>
            <h3>
                Average time
            </h3>
            <p>
                The <span>average time</span> is displayed as a metric for each player, but doesn't have any effect on the ranking.
                From your last 15 races, it takes those that were not forfeited and calculates the average time.
                This metric will generally favor those who forfeit more often when they would have gotten a bad time.
            </p>
            <h3>
                Median time
            </h3>
            <p>
                The <span>median time</span> also doesn't influence the ranking in any way.
